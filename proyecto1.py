...
def redraw():
    ...
    if playing:
        ...
        text = font.render('Proyecto 1', False, white)
        ...
        text = font.render('Nivel: ' + str(ship.level), False, white)
        ...
        text = font.render('Marcador: ' + str(ship.score), False, white)
        ...
        font = pygame.font.SysFont('nuevo', 60)

        text = font.render('Proyecto 1', False, green)
        ...
        text = font.render('Marcador: ' + str(ship.highscore), False, white)
        ...
        text = font.render('Presiona la tecla espacio para inciar', False, green)
